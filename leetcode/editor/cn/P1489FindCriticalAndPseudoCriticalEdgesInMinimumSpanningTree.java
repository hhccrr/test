...
/**
 * @Author cxy
 * @Date 2021-01-21 14:56:01
 * @Version 1.0
 * @Description 找到最小生成树里的关键边和伪关键边
 */
class N1489FindCriticalAndPseudoCriticalEdgesInMinimumSpanningTree {
    public static void main(String[] args) {
        Solution solution = new N1489FindCriticalAndPseudoCriticalEdgesInMinimumSpanningTree().new Solution();
        // TO TEST
    }
